<?php
/*
Template Name: Польский кабель - bitner - Кабель для установок пожарной безопасности
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=1616"><li class="active">Кабель для установок пожарной безопасности <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=1622"><li>Кабели специального<br> назначения <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/03/bitner.jpg">Огнестойкие (огнеупорные) кабели применяются для обеспечения работоспособности пожарных сигнализаций, системы оповещения и остальных систем безопасности. Как правило, кабель покрыт специальной оболочкой, которая обладает способностью противостоять огню и высоким температурам.
<br>
<cite>Купить кабели и провода вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта кабели и провода со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на кабели и провода делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=127&orderby=title&order=asc&showposts=1000');
