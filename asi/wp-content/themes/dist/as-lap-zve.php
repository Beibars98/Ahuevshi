<?php
/*
Template Name: Арматура на AC - Арматура для ЛЭП - Звенья промежуточные
...
<html>
  ...
  <?php get_header(); ?>
    <article>
    <h2>Звенья промежуточные</h2>
    <hr>
    <p><a href="http://asiaelectro.kz/?page_id=40604#">Наша продукция</a> <span class="glyphicon glyphicon-chevron-right"></span> <a href="http://asiaelectro.kz/?page_id=2466">Арматура на АС</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="#" class="active">Звенья промежуточные</a></p>
	<ul>
  ...
  <a href="http://asiaelectro.kz/?page_id=19489"><li class="active">Звенья промежуточные <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=19501"><li>Коромысла <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption>Звенья промежуточные переходные трехлапчатые типа ПРТ предназначены для удлинения гирлянд изоляторов, а также для перехода с однолапчатой проушины на двухлапчатую. Звенья промежуточные соответствуют требованиям ТУ 3449-109-00111120-95.
...
<cite>Купить арматуру на АС вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта арматуру на АС со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на арматуру на АС делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=214&orderby=title&order=asc&showposts=10000');
