<?php
/*
Template Name: Кабельные лотки и металлоизделия - Россия - IEK - Метизы
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=29027"><li class="active">Метизы <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
    </ul>
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Предназначены для монтажа металлических лотков (прокатных или проволочных) по элементам здания (потолок, стены, пол).
<br>
<cite>Купить Кабельные лотки и металлоизделия вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта кабельные лотки и металлоизделия со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на кабельные лотки и металлоизделия делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=345&orderby=title&order=asc&showposts=10000');
