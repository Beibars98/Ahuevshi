<?php
/*
Template Name: Арматура на AC - Металлоконструкции для ЛЭП - Оголовья и накладки ОГ
...
<html>
  ...
  <?php get_header(); ?>
    <article>
    <h2>Оголовья и накладки ОГ</h2>
    <hr>
    <p><a href="http://asiaelectro.kz/?page_id=40604#">Наша продукция</a> <span class="glyphicon glyphicon-chevron-right"></span> <a href="http://asiaelectro.kz/?page_id=2466">Арматура на АС</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="#" class="active">Оголовья и накладки ОГ</a></p>
	<ul>
  ...
  <a href="http://asiaelectro.kz/?page_id=19766"><li class="active">Оголовья и накладки ОГ <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=19780"><li>Хомуты <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption>Крепление элементов воздушных линий электропередач напряжением до 10 кВ (провода, изоляторы и изолирующие подвески) к опорам осуществляется с помощью оголовий и накладок. Многообразие типов оголовий и накладок ОГ обеспечивает надежное крепление всех элементов к опорам любого вида.
<br>
<cite>Купить арматуру на АС вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта арматуру на АС со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на арматуру на АС делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=237&orderby=title&order=asc&showposts=10000');
