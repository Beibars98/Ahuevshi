<?php
/*
Template Name: Kabel-prov-066-6
...
<html>
  ...
  <?php get_header(); ?>
    <article>
    <h2>Cиловые кабели в ПВХ изоляции 0,66-6 кВ</h2>
    <hr>
    <p><a href="http://asiaelectro.kz/?page_id=40604#">Наша продукция</a> <span class="glyphicon glyphicon-chevron-right"></span> <a href="http://asiaelectro.kz/?page_id=40624">Кабельно-проводниковая продукция</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="http://asiaelectro.kz/?page_id=40637">Россия</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="#" class="active">Cиловые кабели в ПВХ изоляции 0,66-6 кВ</a></p>
	<ul>
  ...
  <a href="http://asiaelectro.kz/?page_id=775"><li class="active">Cиловые кабели в ПВХ изоляции 0,66-6 кВ <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
...
<br>
Кабели предназначены для вертикальных, наклонных и горизонтальных трасс. Небронированные кабели могут использоваться в местах подверженных вибрации. Кабели не распространяют горение при одиночной прокладке (нормы МЭК 60332-1). Кабели с индексом «нг» не распространяют горение при прокладке в пучках (нормы МЭК 60332-3 категории А и В). Кабели плоской формы обозначаются индексом «-П». Кабели в тропическом климатическом исполнении (индекс «-Т») устойчивы к воздействию плесневых грибов.
<br>
...
<cite>Купить кабели и провода вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта кабели и провода со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на кабели и провода делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite>
    ...
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=82&orderby=title&order=asc&showposts=1000');
