<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Модульное оборудование - Автоматические выключатели - Автоматические выключатели ВА47-100
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=20626"><li class="active">Автоматические выключатели ВА47-100 <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>		
    </ul>
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Автоматические выключатели ВА47-100 предназначены для защиты распределительных и групповых цепей, имеющих активную и индуктивную нагрузки.
<br>
Рекомендуются к применению в вводно-распределительных устройствах бытовых и промышленных электроустановок.
<br>
...
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=259&orderby=title&order=asc&showposts=10000');
