<?php
/*
Template Name: Немецкий кабель - helukabel - Монтажные провода
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=1585"><li class="active">Монтажные провода <span class="glyphicon glyphicon-chevron-right"   style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=1592"><li>Кабели для передачи данных <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/03/helukabel.jpg"><strong>Монтажные провода HELUKABEL</strong> предназначены для использования в трубах, проложенных по штукатурке, в штукатурке и под штукатуркой, а также в закрытых каналах электропроводки.
Нельзя использовать для проводки непосредственно на платформах, в желобах или в ваннах. Монтажные провода HELUKABEL допущены для внутреннего соединения приборов, распределительных щитов и распределительных устройств, а также для защищенной проводки в осветительных приборах и для их подключения с номинальным напряжением до 1000 В переменным или постоянным напряжением до 750 В относительно земли.
<br>
<cite>Купить кабели и провода Helukabel вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете как выбрать необходимые для вашего проекта кабели и провода со складов в Алматы, так и заказать любую кабельно-проводниковую продукцию со складов Helukabel в Германии или под производство. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на кабели и провода Helukabel делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite>
    ...
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=100&orderby=title&order=asc&showposts=1000');
