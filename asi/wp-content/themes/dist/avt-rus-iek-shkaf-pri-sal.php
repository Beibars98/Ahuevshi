<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Шкафы, боксы и принадлежности к ним - Принадлежности и аксессуары для шкафов - Сальники и кабельные вводы
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=25486"><li class="active">Сальники и кабельные вводы <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=25497"><li>Принадлежности прочие <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Предназначены для ввода проводов и кабелей в электрощитовое оборудование с целью защиты проводников от механического повреждения и защиты самой сборки от проникновения пыли и влаги в месте ввода. Корпус, гайка уплотнения и фиксирующая гайка выполнены из полиамида. Установка сальника производится при помощи трубного (газового) ключа.
<br>
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=306&orderby=title&order=asc&showposts=10000');
