<?php
/*
Template Name: Польский кабель - bitner - Кабель для сервопривода
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=1612"><li class="active">Кабель для сервопривода <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=1622"><li>Кабели специального<br> назначения <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/03/bitner.jpg">Кабели на сервопривода соответствуют правилам электромагнитной совместимости, выполнены либо как готовые устройства, либо как нулевые кабели, которые представляют из себя только разъемы, которые необходимо припаивать с кабелю необходимой длины. 
<br>
<cite>Купить кабели и провода вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта кабели и провода со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на кабели и провода делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=125&orderby=title&order=asc&showposts=1000');
