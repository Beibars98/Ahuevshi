<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Модульное оборудование - Дополнительные модульные устройства - Ограничители импульсных перенапряжений ОПС1
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=22288"><li class="active">Ограничители импульсных перенапряжений ОПС1 <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=22292"><li>Контакторы модульные КМ <span class="glyphicon glyphicon-chevron-right"></span></li></a>		
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Ограничитель импульсных перенапряжений ОПС1 (УЗИП) предназначен для защиты внутренних распределительных цепей жилых и общественных зданий от грозовых и коммутационных импульсных перенапряжений.
<br>
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=264&orderby=title&order=asc&showposts=10000');
