<?php
/*
Template Name: Арматура на AC - Арматура для ЛЭП - Зажимы - Зажимы поддерживающие
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=19511"><li class="active">Зажимы поддерживающие <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=19517"><li>Зажимы заземляющие <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption>Зажимы поддерживающие ПГН глухие предназначены для крепления одного провода к изолирующим подвескам линий электропередачи напряжением 35, 110, 220 кВ. Соответствуют требованиям ТУ 3449-126-00-111120-97. 
<br>
<cite>Купить арматуру на АС вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта арматуру на АС со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на арматуру на АС делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=225&orderby=title&order=asc&showposts=10000');
