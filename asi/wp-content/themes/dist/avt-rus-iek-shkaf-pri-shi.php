<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Шкафы, боксы и принадлежности к ним - Принадлежности и аксессуары для шкафов - Шины соединительные
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=25482"><li class="active">Шины соединительные <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=25497"><li>Принадлежности прочие <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Применяются для удобного и безопасного соединения групп: ВА (выключатели автоматические), АД (автоматы дифференциальные), ВД (выключатели дифференциальные), ВН (выключатели нагрузки).<br>
Шины с шагом 18 мм предназначены для коммутации аппаратуры шириной, кратной одному модулю, шины с шагом 27 мм предназначены для коммутации изделий шириной, кратной полутора модулям.<br>
Шины, рассчитанные на номинальный ток 100 А, могут быть использованы с номинальным током 125 А, если вводной автомат подключать по центру. Для полуторамодульных шин имеются боковые заглушки.
<br>
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=304&orderby=title&order=asc&showposts=10000');
