<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Шкафы, боксы и принадлежности к ним - Корпуса пластиковые - Корпуса пластиковые IP2x-3x-4x
...
<html>
  ...
  <?php get_header(); ?>
    <article>
    <h2>Корпуса пластиковые IP2x-3x-4x</h2>
    <hr>
    <p><a href="http://asiaelectro.kz/?page_id=40604#">Наша продукция</a> <span class="glyphicon glyphicon-chevron-right"></span> <a href="http://asiaelectro.kz/?page_id=2536">Низковольтное оборудование</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="http://asiaelectro.kz/?page_id=2540">Россия</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="http://asiaelectro.kz/?page_id=2562">IEK</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="http://asiaelectro.kz/?page_id=23880">Шкафы, боксы и принадлежности к ним</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="#" class="active">Корпуса пластиковые IP2x-3x-4x</a></p>
	<ul>
  <a href="http://asiaelectro.kz/?page_id=23885"><li class="active">Корпуса пластиковые IP2x-3x-4x <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
...
<br>
Надежная, современная конструкция и прочный пластик, удобные крепежные приспособления гарантируют изделиям долгий срок службы и безопасность эксплуатации. Гарантированное качество продукции обеспечивается соответствием требованиям государственных российских и международных стандартов. 
Используются в жилых и производственных помещениях.
<br>
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=287&orderby=title&order=asc&showposts=10000');
