<?php
/*
Template Name: Немецкий кабель - Lapp group - Кабели для серво-двигателей
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=1598"><li class="active">Кабели для серводвигателей <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=1608"><li>Кабели для экстремальных условий эксплуатации <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/03/lappgroup.jpg">«Быстрее,  дольше, экономичнее – вот требования производителей оборудования, разработчиков механических станков, которые обычно предъявляются к производителям кабеля», объясняет менеджер по продукции Фолькер Губер. Сегодня необходимо производить более крупные изделия за более короткий период времени. Это говорит о потребности в постоянном повышении скоростей перемещения и ускорения технологических процессов. В результате движущиеся части должны быть как можно меньше и легче. Такие же требования стоят перед электрическими, гидравлическими, пневматическими и контрольно-соединительными кабелями.
<br>
<cite>Купить кабели и провода вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта кабели и провода со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на кабели и провода делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=106&orderby=title&order=asc&showposts=1000');
