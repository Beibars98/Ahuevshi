<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Шкафы, боксы и принадлежности к ним - Принадлежности и аксессуары для шкафов - Принадлежности прочие
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=25497"><li class="active">Принадлежности прочие <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
    </ul>
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Предназначены для создания упорядоченных систем ввода, учета, автоматизации и распределения электроэнергии, используются при комплектации электрощитого оборудования.<br>
Ассортимент аксессуаров постоянно расширяется и обновляется, следуя современным тенденциям рынка и запросам конечных клиентов. Собственная лаборатория позволяет проводить проверку по основным техническим параметрам.
<br>
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=311&orderby=title&order=asc&showposts=10000');
