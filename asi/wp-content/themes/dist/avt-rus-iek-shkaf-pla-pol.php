<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Шкафы, боксы и принадлежности к ним - Корпуса пластиковые - Корпуса полиэстерные
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=23891"><li class="active">Корпуса полиэстерные <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a> 		
    </ul>
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Полиэстерные корпуса щитов ввода и учета электроэнергии ЩУ предназначены для установки счетчиков электрической энергии и модульного оборудования. Благодаря конструкции корпусов и свойствам материала, из которого они изготовлены, могут быть установлены в помещениях с высоким содержанием пыли, влаги и вредных веществ, а также на открытом воздухе.
<br>
Полиэстерные щиты с монтажной панелью ЩМП предназначены для сборки разнообразных электрощитов: силовых, управления, автоматики. Позволяют производить монтаж аппаратуры как модульного, так и обычного исполнения.
<br>
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=290&orderby=title&order=asc&showposts=10000');
