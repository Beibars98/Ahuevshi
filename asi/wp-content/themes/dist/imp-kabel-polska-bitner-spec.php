<?php
/*
Template Name: Польский кабель - bitner - Кабели специального назначения
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=1622"><li class="active">Кабели специального<br> назначения <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
    </ul>
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/03/bitner.jpg">Кабели и провода специального назначения, это провода, использующиеся при монтаже бортовых сетей авиатехники. Данные кабели востребованы в ряде видов высокотехнологичных и сложных техники, оборудования и машинах.
<br>
<cite>Купить кабели и провода вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта кабели и провода со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на кабели и провода делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=130&orderby=title&order=asc&showposts=1000');
