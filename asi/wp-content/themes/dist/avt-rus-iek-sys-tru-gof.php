<?php
/*
Template Name: Низковольтное оборудование - Россия - IEK - Системы для прокладки кабеля - Трубы пластиковые - Трубы пластиковые гофрированные
...
<html>
  ...
  <?php get_header(); ?>
    <article>
    <h2>Трубы пластиковые гофрированные</h2>
    <hr>
    <p><a href="http://asiaelectro.kz/?page_id=40604#">Наша продукция</a> <span class="glyphicon glyphicon-chevron-right"></span> <a href="http://asiaelectro.kz/?page_id=2536">Низковольтное оборудование</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="http://asiaelectro.kz/?page_id=2540">Россия</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="http://asiaelectro.kz/?page_id=2562">IEK</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="http://asiaelectro.kz/?page_id=26431">Системы для прокладки кабеля</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="#" class="active">Трубы пластиковые гофрированные</a></p>
	<ul>
  <a href="http://asiaelectro.kz/?page_id=27065"><li class="active">Трубы пластиковые гофрированные <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=27069"><li>Изделия монтажные для пластиковых труб <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption><img src="http://asiaelectro.kz/wp-content/uploads/2018/07/IEK_.jpg">Гофрированные трубы используются для прокладки силовых и слаботочных линий скрытого типа внутри зданий и сооружений. Благодаря гибкости трубы, прокладка кабеля осуществляется с минимальными трудозатратами и практически не требует дополнительных аксессуаров.
<br>
<cite>Купить низковольтное оборудование вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта низковольтное оборудование со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на низковольтное оборудование делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=327&orderby=title&order=asc&showposts=10000');
