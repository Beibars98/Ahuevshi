<?php
/*
Template Name: Арматура на AC - Арматура для ЛЭП - Зажимы - Зажимы аппаратные
...
<html>
  ...
  <a href="http://asiaelectro.kz/?page_id=19507"><li class="active">Зажимы аппаратные <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=19517"><li>Зажимы заземляющие <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption>Зажимы аппаратные предназначены для крепления к выводам аппаратов и для соединения с ответвительными зажимами. Зажимы аппаратные используются для присоединения двух, трех, четырех и пяти проводов к выводам аппаратов.
<br>
<cite>Купить арматуру на АС вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта арматуру на АС со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на арматуру на АС делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=223&orderby=title&order=asc&showposts=10000');
