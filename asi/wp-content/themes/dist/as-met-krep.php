<?php
/*
Template Name: Арматура на AC - Металлоконструкции для ЛЭП - Крепление провода СШ--2
...
<html>
  ...
  <?php get_header(); ?>
    <article>
    <h2>Крепление провода СШ--2</h2>
    <hr>
    <p><a href="http://asiaelectro.kz/?page_id=40604#">Наша продукция</a> <span class="glyphicon glyphicon-chevron-right"></span> <a href="http://asiaelectro.kz/?page_id=2466">Арматура на АС</a>  <span class="glyphicon glyphicon-chevron-right"></span>  <a href="#" class="active">Крепление провода СШ--2</a></p>
	<ul>
  ...
  <a href="http://asiaelectro.kz/?page_id=19758"><li class="active">Крепление провода СШ--2 <span class="glyphicon glyphicon-chevron-right" style="color: white;"></span></li></a>
  ...
  <a href="http://asiaelectro.kz/?page_id=19780"><li>Хомуты <span class="glyphicon glyphicon-chevron-right"></span></li></a>
	...
	<figcaption>  Для надежного крепления провода к изолятору используется специальная скоба из пружинной стали СШ-1, СШ-2, СШ-3. Кроме надежности, использование скобы значительно снижает время монтажа, затрачиваемое специалистами, в сравнении со временем необходимым для традиционной проволочной вязки. В результате стоимость монтажных работ значительно снижается, и сокращаются сроки.
<br>
<cite>Купить арматуру на АС вы всегда можете в ТОО "Корпорация Gulfstream". Вы можете выбрать необходимые для вашего проекта арматуру на АС со складов в Алматы. Продуманная логистика позволяет предложить оптимальные сроки поставки продукции, а низкие цены на арматуру на АС делают сотрудничество с <strong>ТОО "Корпорация Gulfstream"</strong> бескомпромиссным вариантом.</cite></figcaption>	
    <table class="table_blur">	
      <tr>
		...
		<?php 
        $wp_query = new WP_Query(); $wp_query->query('cat=233&orderby=title&order=asc&showposts=10000');
